...
//
// Each entry: { title, link, published, abstract, cover }.
...
//   - published: optional { venue, url } — where the paper is publicly
//     listed (e.g. SSRN). Shown under the title, above the PDF button.
  ...
  list: [
    {
      ...
      published: { venue: 'SSRN', url: 'https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7373058' },
