...
- Project descriptions are written in **first person** ("I want", "I believe", "I built") going forward, per Anson's direct instruction — not third person ("Anson believes..."). Applied so far to P&L Tracker, Compersion and Solace, AI Newsletter, and Daily Gap Ups; SignalFeed, Algo Trading Bot, and Earnings Signal Agent still read third-person and haven't been touched — ask before converting them too, don't do it silently.
